// src/app/features/home/components/product-showcase/product-showcase.component.ts
...
// CORRECCIÓN: Se importa el modelo canónico.
...
export class ProductShowcaseComponent {
  // CORRECCIÓN: La propiedad 'products' ahora usa el tipo 'Product' importado.
  products: Product[];
  ...
  constructor() {
    ...
    // El array ahora se ajusta a la estructura completa del modelo canónico.
    // Se añaden las propiedades que faltaban, aunque estén vacías.
    this.products = [
      { id: 'p1', name: 'Teclado Mecánico Void-Dasher', imageUrl: 'https://placehold.co/400x300/111827/FFFFFF?text=Teclado+RGB', tags: ['PC', 'PS5'], price: 85, specs: [ { name: 'Switches Blue', delay: '150ms', iconPath: keyboardIcon }, { name: 'RGB Completo', delay: '250ms', iconPath: rgbIcon }, { name: 'Anti-Ghosting', delay: '350ms', iconPath: ghostIcon } ], category: 'gaming', description: '' },
      { id: 'p2', name: 'Proyector Hyperion X1', imageUrl: 'https://placehold.co/400x300/111827/FFFFFF?text=Proyector+4K', tags: ['Android TV', 'AirPlay'], price: 149, oldPrice: 199, specs: [ { name: '1600 Lúmenes', delay: '150ms', iconPath: lumenIcon }, { name: 'Resolución 4K', delay: '250ms', iconPath: resolutionIcon }, { name: 'Android TV 11', delay: '350ms', iconPath: androidIcon } ], category: 'proyectores', description: '' },
      { id: 'p3', name: 'Cámara de Seguridad 360 Pro', imageUrl: 'https://placehold.co/400x300/111827/FFFFFF?text=Cámara+360', tags: ['WiFi', 'Google Home'], price: 79, specs: [ { name: 'Visión Nocturna', delay: '150ms', iconPath: nightVisionIcon }, { name: 'Detección IA', delay: '250ms', iconPath: aiIcon }, { name: 'Audio 2 Vías', delay: '350ms', iconPath: audioIcon } ], category: 'seguridad', description: '' },
    ];
  }
}
