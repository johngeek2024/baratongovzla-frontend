...
interface FlashDeal {
  ...
  price: number;
  oldPrice: number;
  endTime: string; // Fecha en formato ISO: 'YYYY-MM-DDTHH:mm:ss'
}
...
export class FlashDealsComponent implements AfterViewInit, OnDestroy {
  ...
  public deals: FlashDeal[] = [
    { id: 'deal1', title: 'Auriculares Gamer Inmersivos X-1', imageUrl: 'https://placehold.co/400x300/111827/FFFFFF?text=Audífonos+Gamer', discount: 40, price: 69, oldPrice: 115, endTime: '2025-07-22T23:59:59' },
    { id: 'deal2', title: 'Smartwatch Elite Pro Series 5', imageUrl: 'https://placehold.co/400x300/111827/FFFFFF?text=Smartwatch+Elite', discount: 25, price: 150, oldPrice: 200, endTime: '2025-07-25T23:59:59' },
    { id: 'deal3', title: 'Mouse Vertical Ergonómico Lift', imageUrl: 'https://placehold.co/400x300/111827/FFFFFF?text=Mouse+Vertical', discount: 30, price: 35, oldPrice: 50, endTime: '2025-08-01T23:59:59' }
  ];

  // Usamos un signal para almacenar los valores del temporizador de forma reactiva
  public timers = signal<Timer[]>([]);

  constructor(@Inject(PLATFORM_ID) private platformId: Object) {
    // Inicializamos el array de timers con valores por defecto
  ...
  private startTimers(): void {
    this.timerInterval = window.setInterval(() => {
      ...
      // Actualizamos el signal con los nuevos valores, lo que refrescará la vista automáticamente
